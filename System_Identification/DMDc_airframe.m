...
elseif mode == 3 % yaw mode 
    ...
    xOutput = state_matrix_X(:, time_start:time_end);
    xInputs_act = [M1_dmdc;M2_dmdc;M3_dmdc;M4_dmdc];
end
...
function Plot = Plot_Model(mode_type , state_matrix_X , Input , sys , ts , te , dt, seed , title_input)
    ...
    full_state_ref = state_matrix_X(:, ts / dt: te / dt);
    ...
    elseif mode_type == 3 % yaw mode 
        ...
        subplot(9,1,3)
        plot(Time_gen, rad2deg(state_out_ref(3,:)), 'b', 'Linewidth', 1.5); hold on; grid on;
        plot(Time_gen, rad2deg(state_out_gen(:,3)), 'r--', 'Linewidth', 1.5);
        title("Yaw Angle (ψ)", 'FontSize', 12);
        ylabel('ψ (°)', 'FontSize', 11);

        subplot(9,1,4)
        plot(Time_gen, state_out_ref(10,:), 'b', 'Linewidth', 1.5);hold on; grid on;
        plot(Time_gen, state_out_gen(:,10), 'r--', 'Linewidth', 1.5); 
        title("Linear Velocity (u)", 'FontSize', 12);
        ylabel('u (m/s)', 'FontSize', 11);
        
        subplot(9,1,5)
        plot(Time_gen, state_out_ref(11,:).', 'b', 'Linewidth', 1.5);hold on; grid on;
        plot(Time_gen, state_out_gen(:,11), 'r--', 'Linewidth', 1.5); 
        title("Linear Velocity (v)", 'FontSize', 12);
        ylabel('v (m/s)', 'FontSize', 11);
        
        subplot(9,1,6)
        plot(Time_gen, state_out_ref(12,:), 'b', 'Linewidth', 1.5);hold on; grid on;
        plot(Time_gen, state_out_gen(:,12), 'r--', 'Linewidth', 1.5); 
        title("Linear Velocity (w)", 'FontSize', 12);
        ylabel('w (m/s)', 'FontSize', 11);
        
        subplot(9,1,7)
        plot(Time_gen, state_out_ref(4,:), 'b', 'Linewidth', 1.5);hold on; grid on;
        plot(Time_gen, state_out_gen(:,4), 'r--', 'Linewidth', 1.5); 
        title("Angular Velocity (p)", 'FontSize', 12);
        ylabel('p (°/s)', 'FontSize', 11);
       
        subplot(9,1,8)
        plot(Time_gen, rad2deg(state_out_ref(5,:)), 'b', 'Linewidth', 1.5);hold on; grid on;
        plot(Time_gen, rad2deg(state_out_gen(:,5)), 'r--', 'Linewidth', 1.5); 
        title("Angular Velocity (q)", 'FontSize', 12);
        ylabel('q (°/s)', 'FontSize', 11);

        subplot(9,1,9)
        plot(Time_gen, rad2deg(state_out_ref(6,:)), 'b', 'Linewidth', 1.5);hold on; grid on;
        plot(Time_gen, rad2deg(state_out_gen(:,6)), 'r--', 'Linewidth', 1.5); 
        legend("ground truth", "DMDc estimate", 'FontSize', 10);
        title("Angular Velocity (r)", 'FontSize', 12);
        ylabel('r (°/s)', 'FontSize', 11);
